var organizasyonSemasiControllers = angular.module('mainApp.controllers.organizasyon.organizasyonSemasiController', ['BasicPrimitives']);

organizasyonSemasiControllers
...
organizasyonSemasiControllers.controller('organizasyonSemasiController', ['$rootScope', '$scope', '$timeout', '$filter', 'organizasyonSemasiService', 'inkaService', 'personelService',
function ($rootScope, $scope, $timeout, $filter, organizasyonSemasiService, inkaService, personelService) {
    ...
    $scope.FillIKBirimList = function () {
        //var request = {
        //    IKSirketObjId: $scope.IKSirketObjId,
        //};
        ...
        // .ikBirimList(request)
        // .success(function (data, status, headers, config) {
        //     $scope.Birimler = data.Data.Entities;
        //     $scope.RefreshChosen('birim-select');
        // });
    };
    ...
    var items = [
        new primitives.orgdiagram.ItemConfig({
            ...
            image: Q.ResolveUrl('theme/img/a.png'),
        ...
        new primitives.orgdiagram.ItemConfig({
            ...
            image: Q.ResolveUrl('theme/img/b.png'),
            itemTitleColor: primitives.common.Colors.RoyalBlue
        }),
        new primitives.orgdiagram.ItemConfig({
            id: 2,
            ...
            image: Q.ResolveUrl('theme/img/c.png'),
            itemTitleColor: primitives.common.Colors.RoyalBlue
        }),
        new primitives.orgdiagram.ItemConfig({
            id: 3,
            ...
            image: Q.ResolveUrl('theme/img/e.png'),
