...
mainApp.controller('mainAppController', ['$rootScope', 'moment', function ($rootScope, moment) {
    moment.locale('tr', {
...
mainApp.factory('RequestsErrorHandler', ['$q', '$rootScope', function ($q, $rootScope) {
    return {
...
mainApp.filter('getEnumName', function ($rootScope) {
    return function (key, enumType) {
        return $rootScope[enumType].filter(function (enumP) {
