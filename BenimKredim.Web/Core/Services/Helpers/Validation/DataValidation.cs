...
//                {
//                    throw ReadOnlyError(row, fields[i]);
//                }
//            }
//        }
...
//        public static void ValidateUniqueValues<T, V>(IEnumerable<T> items, Func<T, V> getValue)
//        {
...
//                    throw new DuplicateNameException("items");
//                values.Add(value);
//            }
//        }
...
//        public static void CopyOldValuesFrom(this Row row, Row old)
//        {
...
//        public static void CopyValuesFrom(this Row row, Row source)
//        {
//            if (!row._tracking)
//                row._tracking = true;
...
//            foreach (var field in row.GetFields())
//                if (!row.IsAssigned(field))
//                    field.Copy(source, row);
//        }

//        public static void CopyValuesFrom(this Row row, Row source, List<Field> ExceptFields)
//        {
//            if (!row._tracking)
//                row._tracking = true;
...
//                Convert.ToString(id, CultureInfo.CurrentCulture), GetEntitySingular(row));
//        }
...
//        public static string GetEntitySingular(Row row)
//        {
//            string prefix = row.GetFields().LocalTextPrefix;
//            return LocalText.TryGet("Db." + prefix + ".EntitySingular") ?? prefix;
//        }
...
//        {
//            var query = new SqlSelect("1").From(tableName, 0);
//            filter(query);
...
//        {
//            var query = new SqlSelect("1").From(tableName);
//            filter(query);
//            if (query.Take(1).Exists(connection))
